...
import {
  ArrowRight, Building2, Truck, ShieldCheck, FileCheck2, QrCode, Recycle,
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container relative grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-7">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-xl">
              Conectamos restaurantes, pollerías y locales de comida con recolectores autorizados. Trazabilidad
              completa, valorización económica y cumplimiento ambiental en una sola plataforma.
            </p>
            ...
            <div className="flex items-center gap-6 pt-4 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-success"/> Trazabilidad QR</div>
          ...
          <div className="relative">
            ...
            <Card className="absolute -bottom-6 -left-6 p-4 shadow-lg bg-card/95 backdrop-blur w-56 hidden md:block animate-float">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold font-display">18,420 L</div>
                  <div className="text-[11px] text-muted-foreground">Recolectados este mes</div>
                </div>
              </div>
            </Card>
            <Card className="absolute -top-4 -right-4 p-3 shadow-lg bg-card/95 backdrop-blur hidden md:block">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-semibold">142 empresas activas</span>
              </div>
            </Card>
          </div>
        </div>
      ...
      <section className="border-y border-border bg-card">
        <div className="container py-10 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
          {[
            { v: "18,420 L", l: "Recolectados", i: Droplets },
            { v: "142", l: "Empresas activas", i: Building2 },
            { v: "12", l: "Recolectores", i: Truck },
            { v: "8", l: "Distritos", i: MapPin },
            { v: "S/ 51,576", l: "Pagos procesados", i: TrendingUp },
            { v: "312", l: "Certificados emitidos", i: Award },
          ].map((s, i) => (
      ...
      <section id="problema" className="py-24">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="text-muted-foreground">Cada litro de aceite vertido al desagüe contamina hasta 1,000 litros de agua. En Tacna se generan miles de litros mensuales sin trazabilidad ni disposición formal.</p>
          </div>
          <div className="grid md:grid-cols-4 gap-5">
            {[
              ...
              { i: ShieldCheck, t: "Falta de trazabilidad", d: "No existe seguimiento del residuo desde origen a destino." },
            ].map((p, i) => (
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { n: "05", i: QrCode, t: "Trazabilidad emitida", d: "Se genera código único y QR del residuo recolectado." },
              { n: "06", i: FileCheck2, t: "Pago y certificado", d: "Liquidación por litro y certificado ambiental descargable." },
            ].map((s, i) => (
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                d: "Empresas autorizadas que ejecutan los recojos, registran litros reales y emiten constancias de trazabilidad.",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { i: QrCode, t: "Trazabilidad QR", d: "Demuestra disposición correcta." },
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <Card className="p-8 border-2 border-accent relative overflow-hidden flex flex-col shadow-lg shadow-accent/10">
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-center gap-2 text-sm"><CheckCircle2 className="h-4 w-4 text-accent" /> Trazabilidad y QR ilimitados</li>
