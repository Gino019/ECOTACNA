        ...
        <div className="container relative grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-7">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-xl">
              Conectamos restaurantes, pollerías y locales de comida con recolectores autorizados. Valorización económica y cumplimiento ambiental en una sola plataforma.
            </p>
      ...
      <section id="problema" className="py-24">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="text-muted-foreground">Cada litro de aceite vertido al desagüe contamina hasta 1,000 litros de agua. En Tacna se generan miles de litros mensuales sin disposición formal.</p>
          </div>
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { n: "05", i: FileCheck2, t: "Pago confirmado", d: "Liquidación por litro en cuenta del recolector." },
            ].map((s, i) => (
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                features: ["Solicitar recojo en 1 clic", "Seguimiento referencial", "Liquidaciones por litro", "Historial completo"]
              },
              {
                role: "Recolector",
