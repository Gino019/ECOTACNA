...
export default function RegisterCompanyPage() {
  ...
  const handleSelectPlan = (planType: 'GENERADOR' | 'RECOLECTOR') => {
    ...
    const amount = planType === 'GENERADOR' ? 20 : 250;
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          ...
          <Card className={`p-8 border-2 bg-white flex flex-col justify-between rounded-3xl transition-all shadow-md ${
            auxiliaryData?.tipoEmpresa === "GENERADOR" ? "border-green-500 ring-2 ring-green-500/10 scale-105" : "border-gray-150 opacity-60"
          }`}>
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-baseline gap-1">
                  <span className="text-4xl font-extrabold text-gray-900">S/ 20</span>
          ...
          <Card className={`p-8 border-2 bg-white flex flex-col justify-between rounded-3xl transition-all shadow-md ${
            auxiliaryData?.tipoEmpresa === "RECOLECTOR" ? "border-green-500 ring-2 ring-green-500/10 scale-105" : "border-gray-150 opacity-60"
          }`}>
            <div className="space-y-4">
              <div className="flex justify-between items-start">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-baseline gap-1">
                  <span className="text-4xl font-extrabold text-gray-900">S/ 250</span>
                  <span className="text-gray-400 text-sm font-semibold">/ mes</span>
                </div>
              </div>
            ...
            <div className="mt-8 space-y-3">
              <div className="text-left text-xs bg-gray-50 p-3 rounded-xl border border-gray-100">
                <div className="flex justify-between text-gray-600">
                  ...
                  <span className="font-bold font-semibold text-gray-900">S/ 250.00</span>
                </div>
                <div className="flex justify-between text-gray-400 mt-0.5">
