...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> login(@Valid @RequestBody LoginRequest request) {
        ...
        AuthResponse response = AuthResponse.builder()
                ...
                .companyId(user.getCompany() != null ? user.getCompany().getId() : null)
                .userId(user.getId())
                .companyType(user.getCompany() != null && user.getCompany().getCompanyType() != null ? user.getCompany().getCompanyType().name() : null)
                .subscriptionStatus(user.getCompany() != null && user.getCompany().getSubscriptionStatus() != null ? user.getCompany().getSubscriptionStatus().name() : null)
                .build();
