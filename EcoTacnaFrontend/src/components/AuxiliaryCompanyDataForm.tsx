...
export const AuxiliaryCompanyDataForm: React.FC<AuxiliaryCompanyDataFormProps> = ({
  ...
  const handleSaveDraft = () => {
    toast.success("Borrador guardado correctamente (Simulación)");
  };
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
        <Button
          ...
          disabled={isLoading}
          className="font-semibold text-gray-600 rounded-xl hover:bg-gray-50 h-11"
        >
