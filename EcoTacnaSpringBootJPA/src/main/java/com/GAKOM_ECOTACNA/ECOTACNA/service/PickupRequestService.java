...
public class PickupRequestService {
    ...
    public PickupRequest confirmPickup(Long id, Company collectorCompany, User collector, BigDecimal actualVolume, String ipAddress) {
        ...
        if (request.getStatus() != PickupRequestStatus.EN_RUTA && request.getStatus() != PickupRequestStatus.PROGRAMADO) {
            throw new BusinessException("La solicitud debe estar en estado PROGRAMADO o EN_RUTA para poder confirmarla.");
        }
    ...
    public PickupRequest acceptRequest(Long id, User collector, Company collectorCompany, String ipAddress) {
        ...
        boolean tieneRecojoActivo = pickupRequestRepository.existsActiveRequestByCollectorCompanyId(
                ...
                List.of(PickupRequestStatus.PROGRAMADO, PickupRequestStatus.EN_RUTA)
        );
    ...
    public PickupRequest confirmarPago(Long id, Company company, User generatorUser,
        ...
        if (request.getStatus() != PickupRequestStatus.RECOGIDO) {
            throw new BusinessException("El recojo debe estar confirmado por el recolector antes de poder confirmar el pago.");
        }
